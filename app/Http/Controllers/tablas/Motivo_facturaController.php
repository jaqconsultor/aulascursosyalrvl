...
class Motivo_facturaController extends Controller
{
...
[ 'codigo'  => $request->codigo ,'descripcion'  => $request->descripcion ,'monto'  => $request->monto ,'monto_seg'  => $request->monto_seg ,'tipo'  => $request->tipo  ] 
        );
