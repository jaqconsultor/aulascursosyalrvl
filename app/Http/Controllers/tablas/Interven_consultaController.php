...
class Interven_consultaController extends Controller
{
...
[ 'historia'  => $request->historia ,'consulta'  => $request->consulta ,'codigo_inter'  => $request->codigo_inter ,'detalle'  => $request->detalle ,'descripcion'  => $request->descripcion  ] 
        );
