...
Route::prefix('data')->group(function () {
    Route::get('/corregirdata', [App\Http\Controllers\SysMigracion1Controller::class, 'corregirdata']);

    // Llenar las tablas con los datos Iniciales y Vaciar las tablas
    Route::get('/updata', [App\Http\Controllers\SysMigracion1Controller::class, 'updata']);
    Route::get('/downdata', [App\Http\Controllers\SysMigracion1Controller::class, 'downdata']);
});
